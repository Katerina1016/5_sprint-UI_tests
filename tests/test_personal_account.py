...
class TestPersonalAcc:
    ...
    def test_go_to_pesonal_acc_from_main_page_success(self, driver, get_login_driver):
        ...
        WebDriverWait(driver, 15).until(ec.visibility_of_element_located(PersonalAccountLocators.exit_but))
        save_button_displayed = driver.find_element(*PersonalAccountLocators.save_but).is_displayed()

        assert driver.current_url == URLS.PERSONAL_ACCOUNT_PAGE and save_button_displayed
    ...
    def test_go_from_personal_acc_to_constructor_by_click_on_constructor_button_success(self, driver, get_login_driver):
        ...
        driver.find_element(*MainPageLocators.personal_account_but).click()
        WebDriverWait(driver, 30).until(ec.visibility_of_element_located(PersonalAccountLocators.exit_but))
        driver.find_element(*PersonalAccountLocators.constructor_but).click()
        WebDriverWait(driver, 20).until(ec.visibility_of_element_located(MainPageLocators.place_an_order_but))
    ...
    def test_go_from_personal_acc_to_constr_by_click_on_logo_success(self, driver, get_login_driver):
        ...
        WebDriverWait(driver, 20).until(ec.visibility_of_element_located(MainPageLocators.personal_account_but))
        driver.find_element(*MainPageLocators.personal_account_but).click()
        WebDriverWait(driver, 20).until(ec.visibility_of_element_located(PersonalAccountLocators.exit_but))
    ...
    def test_logout_from_personal_acc_success(self, driver, get_login_driver):
        ...
        driver.find_element(*MainPageLocators.personal_account_but).click()
        WebDriverWait(driver, 10).until(ec.visibility_of_element_located(PersonalAccountLocators.exit_but))
        driver.find_element(*PersonalAccountLocators.exit_but).click()
        WebDriverWait(driver, 10).until(ec.visibility_of_element_located(AuthorizationPageLocators.login_account_auth_form_but))
        login_button = driver.find_element(*AuthorizationPageLocators.login_account_auth_form_but)

        assert driver.current_url == URLS.AUTHORIZATION_PAGE and login_button.text == 'Войти'
